  ...
  return (
    <footer className="bg-brand-footer text-white px-6 pt-12 pb-8 rounded-t-3xl sm:rounded-none mt-auto">
      <div className="max-w-md mx-auto">
        <h2 className="font-serif italic text-3xl mb-3">ShopLix</h2>
        <p className="text-neutral-400 text-[14px] sm:text-[15px] leading-relaxed mb-12 text-right" dir="rtl">
          جودة متميزة وأسعار منافسة تجعل تسوقك متعة حقيقية.
        </p>

        <div className="grid grid-cols-2 gap-8 mb-12 text-right" dir="rtl">
          <div>
            <h3 className="text-[13px] tracking-[0.15em] font-semibold text-white mb-4">خدمة العملاء</h3>
          ...
          <div>
            <h3 className="text-[13px] tracking-[0.15em] font-semibold text-white mb-4">روابط سريعة</h3>
            <ul className="flex flex-col gap-3">
        ...
        <div className="border-t border-neutral-800 pt-6 flex flex-col gap-6 text-right" dir="rtl">
          ...
          <div className="flex gap-4 justify-start">
            {[
              ...
              { icon: Send, hoverBg: 'hover:bg-[#0088cc] hover:border-[#0088cc]' }
            ].map((item, idx) => (
              <a 
                key={idx} 
                href="#" 
